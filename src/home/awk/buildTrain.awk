...
NR>1{
    counts[$6]++;        # increment the count of current class
    instances[NR] = $0;  # store instance
    classOf[NR] = $6;    # store class of instance
}

# Go through instances and print the correct amount of that instance based upon its class
END{
